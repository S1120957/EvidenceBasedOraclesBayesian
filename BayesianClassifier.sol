...
/// @title Bayesian Inference Smart Contract for Physician Visit Type Prediction
/// @author ---
/// @notice This contract performs Bayesian inference directly on-chain using four evidence variables:
/// GPS proximity, Patient Confirmation (PC), Prescription Record (PR), and PMD data availability.
...
contract BayesianVisitClassifier {
    ...
    struct Evidence {
        ...
        bool pr;        // Prescription
        bool pmd;       // PMD sensor data
    }
